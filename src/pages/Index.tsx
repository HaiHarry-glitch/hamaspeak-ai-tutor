  ...
  return (
    <div className="min-h-screen overflow-x-hidden relative">
      ...
      <div className="relative z-10">
        ...
        {/* Hero Section */}
        <section id="hero" className={`py-16 md:py-24 transition-all duration-1000 ${visibleSections.hero ? 'opacity-100' : 'opacity-0'} relative`}>
              ...
              <div className="md:w-1/2 relative transform transition-all duration-700 delay-500" 
                ...
                <div className="w-72 h-72 md:w-96 md:h-96 mx-auto relative">
                  ...
                  <div className="absolute inset-0">
                    <Scene3D className="h-full" orbitControls={true} />
                  </div>
        ...
        {/* Method Overview */}
        <section id="method" className={`py-16 transition-all duration-1000 ${visibleSections.method ? 'opacity-100' : 'opacity-0'} relative`}>
          {/* 3D Model in the background */}
          <div className="absolute right-0 top-0 w-1/3 h-full opacity-20 pointer-events-none">
            <Scene3D className="h-full" particles={false} />
          </div>
